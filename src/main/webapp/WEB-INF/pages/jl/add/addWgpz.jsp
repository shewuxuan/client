...
<form class="layui-form layui-form-pane" action="">
    ...
    <%--            <input type="text" name="csxm" autocomplete="off" placeholder="请输入内容" class="layui-input">--%>
    <%--        </div>--%>
    <%--    </div>--%>
    ...
    <div class="layui-form-item layui-form-text">
        <label class="layui-form-label">测试项目</label>
        <div class="layui-input-block">
            <textarea name="csxm" placeholder="请输入内容" class="layui-textarea"></textarea>
        </div>
    </div>

    <div class="layui-form-item layui-form-text">
        <label class="layui-form-label">技术标准或测试要求</label>
        <div class="layui-input-block">
            <textarea name="csyq" placeholder="请输入内容" class="layui-textarea"></textarea>
        </div>
    </div>
...
<script>
    layui.use(['form'], function () {
        ...
        form.on('submit(add)', function (data) {
            ...
            // 判断输入内容不为空
            if (obj.csxm == null || obj.csxm === ""
                || obj.csyq == null || obj.csyq === "") {
                parent.layer.msg("请输入内容", {time: 1500, anim: 6});
                return false;
            }
            $.ajax({
                type: "POST",
                url: "${basePath}/jlwgpz/insert",

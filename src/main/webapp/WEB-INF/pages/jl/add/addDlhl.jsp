...
<form class="layui-form layui-form-pane" action="">
    ...
    <div class="layui-form-item layui-form-text">
        <label class="layui-form-label">测试方法</label>
        <div class="layui-input-block">
            <textarea name="csff" placeholder="请输入内容" class="layui-textarea"></textarea>
        </div>
    </div>
    ...
    layui.use(['form'], function () {
        ...
        form.on('submit(add)', function (data) {
            ...
            if (obj.jg == null || obj.jg === ""
                ...
                || obj.csff == null || obj.csff === "") {
                parent.layer.msg("请输入内容", {time: 1500, anim: 6});
                return false;
            }
            $.ajax({
                type: "POST",
                url: "${basePath}/jldlhl/insert",

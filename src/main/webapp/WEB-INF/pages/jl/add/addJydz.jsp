...
<form class="layui-form layui-form-pane" action="">
    <div class="layui-form-item">
        <label class="layui-form-label">被测回路</label>
        <div class="layui-input-block">
            <input type="text" name="bchl" autocomplete="off" placeholder="请输入内容" class="layui-input">
        </div>
    </div>

    <div class="layui-form-item">
        <label class="layui-form-label">试验电压(伏)</label>
        <div class="layui-input-block">
            <input type="text" name="sydy" autocomplete="off" placeholder="请输入内容" class="layui-input">
        </div>
    </div>
...
<script>
    layui.use(['form'], function () {
        ...
        form.on('submit(add)', function (data) {
            ...
            // 判断输入内容不为空
            if (obj.bchl == null || obj.bchl === ""
                || obj.sydy == null || obj.sydy === "") {
                parent.layer.msg("请输入内容", {time: 1500, anim: 6});
                return false;
            }
            $.ajax({
                type: "POST",
                url: "${basePath}/jljydz/insert",

...
<form class="layui-form layui-form-pane" action="">
    <div class="layui-form-item layui-form-text">
        <label class="layui-form-label">试验仪器名称</label>
        <div class="layui-input-block">
            <textarea name="yqmc" placeholder="请输入内容" class="layui-textarea"></textarea>
        </div>
    </div>
...
<script>
    layui.use(['form'], function () {
        ...
        form.on('submit(add)', function (data) {
            ...
            // 判断输入内容不为空
            if (obj.yqmc == null || obj.yqmc === "") {
                parent.layer.msg("请输入内容", {time: 1500, anim: 6});
                return false;
            }
            $.ajax({
                type: "POST",
                url: "${basePath}/pwbh_jl_yqyb/insert",

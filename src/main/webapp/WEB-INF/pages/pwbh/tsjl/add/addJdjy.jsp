...
<form class="layui-form layui-form-pane" action="">
    <div class="layui-form-item layui-form-text">
        ...
        <div class="layui-input-block">
            <textarea name="csjg" placeholder="请输入内容" class="layui-textarea"></textarea>
        </div>
        <label class="layui-form-label">通入要求值</label>
        <div class="layui-input-block">
            <textarea name="tryq" placeholder="请输入内容" class="layui-textarea"></textarea>
        </div>
    </div>
...
<script>
    layui.use(['form'], function () {
        ...
        form.on('submit(add)', function (data) {
            ...
            // 判断输入内容不为空
            if (obj.csjg == null || obj.csjg === ""
            || obj.tryq == null || obj.tryq ==="") {
                parent.layer.msg("请输入内容", {time: 1500, anim: 6});
                return false;
            }
            $.ajax({
                type: "POST",
                url: "${basePath}/pwbh_jl_jdjy/insert",

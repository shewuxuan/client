                    ...
                    <tr>
                        ...
                        <td bgcolor="#FFFFFF" style="text-align:left; ">
                            <input class="easyui-datebox" name="tssj" id="tssj"
                                   data-options="required:true" value="${pwbhJbxx.tssj}" style="width:120px"/>
                        </td>
                        <th bgcolor="#FFFFFF"><p>安装地点及调度号</p></th>
                        <td bgcolor="#FFFFFF" style="text-align:left; ">
                            <input type="text" name="azddDdh" id="azddDdh" value="${pwbhJbxx.azddDdh}" style="height:25px; border:1px solid #CCC;"/>
                            <input type="hidden" name="tsid" id="tsid" value="${pwbhJbxx.tsid}" style="height:25px; border:1px solid #CCC;"/>
                        </td>
                    </tr>
                    <tr>
                        ...
                        <td bgcolor="#FFFFFF" style="text-align:left; ">
                            <input type="text" name="lm"  ondblclick="defaultClick(this)" value="${pwbhJbxx.lm}" id="lm" style="height:25px; border:1px solid #CCC;"/>
                        </td>
                    </tr>
                    <tr>
                        <th bgcolor="#FFFFFF"><p>工作负责人</p></th>
                        <td bgcolor="#FFFFFF" style="text-align:left; ">
                            <input type="text" name="gzfzr" id="gzfzr" value="${pwbhJbxx.gzfzr}" style="height:25px; border:1px solid #CCC;"/>
                        </td>
                        <th bgcolor="#FFFFFF"><p>工作人员</p></th>
                        <td bgcolor="#FFFFFF" style="text-align:left; ">
                            <input type="text" name="gzry"  value="${pwbhJbxx.gzry}" ondblclick="defaultClick(this)" id="gzry" style="height:25px; border:1px solid #CCC;"/>
                        </td>
                    </tr>
                    <tr>
                        <th bgcolor="#FFFFFF"><p>审核人</p></th>
                        <td bgcolor="#FFFFFF" style="text-align:left; ">
                            <input type="text" name="shr"  value="${pwbhJbxx.shr}" ondblclick="defaultClick(this)" id="shr" style="height:25px; border:1px solid #CCC;"/>
                        </td>
                    </tr>
                    <tr>
                        <th bgcolor="#FFFFFF"><p>备注</p></th>
                        <td bgcolor="#FFFFFF" style="text-align:left; " colspan="3">
                            <textarea name="beizhu" id="beizhu" cols="100" rows="5" style="border:1px solid #CCC;">${pwbhJbxx.beizhu}</textarea>
                        </td>
                    </tr>
                    <tr>

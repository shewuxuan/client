...
<form class="layui-form layui-form-pane" action="">
    ...
    <%--            <input type="text" name="jcnr" autocomplete="off" placeholder="请输入内容" class="layui-input">--%>
    <%--        </div>--%>
    <%--    </div>--%>
    ...
    <div class="layui-form-item layui-form-text">
        ...
        <div class="layui-input-block">
            <textarea name="jcnr" placeholder="请输入内容" class="layui-textarea"></textarea>
        </div>
    </div>
...
<script>
    layui.use(['form'], function () {
        ...
        form.on('submit(add)', function (data) {
            ...
            $.ajax({
                type: "POST",
                url: "${basePath}/ftu_jl_hbdy/insert",

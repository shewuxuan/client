...
<form class="layui-form layui-form-pane" action="">
    ...
    <%--            <input type="text" name="clx" autocomplete="off" placeholder="请输入内容" class="layui-input">--%>
    <%--        </div>--%>
    <%--    </div>--%>

    <div class="layui-form-item layui-form-text">
        <label class="layui-form-label">测试功能</label>
        <div class="layui-input-block">
    ...
    <div class="layui-form-item layui-form-text">
        ...
        <div class="layui-input-block">
            <textarea name="jsbz" placeholder="请输入内容" class="layui-textarea"></textarea>
        </div>
    </div>
...
<script>
    layui.use(['form'], function () {
        ...
        form.on('submit(add)', function (data) {
            ...
            // 判断输入内容不为空
            if (
                obj.csgn == null || obj.csgn === ""
                || obj.jsbz == null || obj.jsbz === ""
            ) {
            ...
            $.ajax({
                type: "POST",
                url: "${basePath}/ftu_jl_gncs/insert",

...
<form class="layui-form layui-form-pane" action="">
    <div class="layui-form-item layui-form-text">
        ...
        <div class="layui-input-block">
            <textarea name="jyxm" placeholder="请输入内容" class="layui-textarea"></textarea>
        </div>
    </div>
    <div class="layui-form-item layui-form-text">
        <label class="layui-form-label">故障模拟</label>
        <div class="layui-input-block">
            <textarea name="gzmn" placeholder="请输入内容" class="layui-textarea"></textarea>
        </div>
    </div>
...
<script>
    layui.use(['form'], function () {
        ...
        form.on('submit(add)', function (data) {
            ...
            // 判断输入内容不为空
            if (
                obj.jyxm == null || obj.jyxm === ""
                || obj.gzmn == null || obj.gzmn === ""
            ) {
            ...
            $.ajax({
                type: "POST",
                url: "${basePath}/ftu_jl_tzyb/insert",

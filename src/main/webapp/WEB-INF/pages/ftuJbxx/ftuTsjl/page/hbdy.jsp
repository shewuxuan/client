        ...
        <form class="layui-form layui-form-pane" action="">
            <div class="layui-form-item layui-form-text">
                ...
                <div class="layui-input-block">
                    <textarea id="hbdybeizhu" placeholder="" class="layui-textarea"></textarea>
                </div>
            </div>
        </form>
    </blockquote>
        ...
        let tableReload = table.render({
            ...
            , cols: [[
                {field: 'id', title: 'ID', type: 'numbers', width: '5%', fixed: 'left', sort: true}
                    , {field: 'jcnr', title: '检查内容', width: '77%', align: 'center', sort: true}
            ...
            , done: function (res, curr, count) {
                ...
                autosave = setInterval(function () {
                    $.ajax({
                        ...
                        success: function (data) {
                            if (data.code === 0) {
                                console.log("hbdy automatically saved successfully!");
                            } else {
                ...
                record = resdata;
                $("[name='select4hbdy']").change(function () {
...
//监听事件
            ...
            switch (obj.event) {
                ...
                case 'ADD':
                    if (${requestScope.userType == 0}) {
                        layer.open({
                            ...
                            maxmin: true,
                            area: ['800px', '520px'],
                            content: '${basePath}/ftuJbxx/ftuTsjl/add/addHbdy/' + tsid + '/' + ssqy
                            , end: function () {
                                tableReload.reload();
                            }
                        });
                ...
                case 'REFRESH':
                    ...
                    $.get("${basePath}/beizhu/selectFtuBeizhuByPrimaryKey/" + tsid, function (data) {
                        $("#hbdybeizhu").val($.parseJSON(data).jlHbdy);
                    });
        ...
        //监听行操作
        table.on('tool(hbdy)', function (obj) {
            let data = obj.data;
            if (obj.event === 'del') {
                layer.confirm('真的删除吗？', function () {
                    $.get("${basePath}/ftu_jl_hbdy/deleteByPrimaryKey/" + data.id, function (result) {
...
<script type="text/html" id="hbdyjg">
    <select name='select4hbdy' lay-ignore lay-search=''>

...
/**
 * @ClassName: ImageAction.java
 * @Description: 动态生成验证码
 * @author: shewuxuan
 * @date: 2019年9月6日 上午11:15:00
 * <p>
 * Modification History:
 * Date         Author          Version            Description
 * ---------------------------------------------------------*
 * 2019年9月6日     shewuxuan           v1.0.0               修改原因
 */
@Controller
@RequestMapping("/img")
public class ImageAction {
     ...
     * @throws Exception
     */
    @RequestMapping("/vcodeimg.action")
    public void ImageCaptcha(HttpServletRequest request, HttpServletResponse response) throws Exception {
        ...
        // 设定背景颜色
        graphics.setColor(new Color(11, 12, 19)); // ---1
...
//     			graphics.setFont(new Font("Arial Black", Font.ITALIC, 18));
        ...
        // 将认证码存入SESSION
        request.getSession().setAttribute("validateCode", resultCode.toUpperCase());
        // 图象生效
        graphics.dispose();
